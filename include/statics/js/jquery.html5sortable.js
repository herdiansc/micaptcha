        ...
        return this.each(function(){
            ...
            var _initLi = function( $li ){
	            ...
	            $li.bind('dragenter', function(ev) {
                    ...
                    if(ev.currentTarget.className != 'filled') {
                        return false;
                    }
                    
                    var newEl = $(this).clone(true);
                    var oldEl = $src.clone(true).removeClass('_dragging').removeClass('hovered');
                    $src.replaceWith(newEl);
                    $(this).replaceWith(oldEl);
                    _initLi( newEl );
                    _initLi( oldEl );
	                return false;
